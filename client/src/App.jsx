...
function App() {
  ...
  return (
    <Router>
      <Container fluid>
        <Row>
          <Col md={9} className="center-main">
            <h1 className="align-item">
              Blockchain Based Plant Monitoring System
            </h1>
            ...
            <Row className="pt-2">
              <Routes>
                ...
                <Route
                  exact
                  path="/stats"
                  element={<Stats data={sheets.data} />}
                />{" "}
